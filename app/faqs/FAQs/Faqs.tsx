        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-12'>
          ...
          <aside>
            <div className="p-8 rounded-xl bg-white border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <Link href={'https://wa.me/23480054669727'} target="_blank" className="w-full flex items-center justify-center gap-2 bg-secondary-blue cursor-pointer hover:bg-secondary-blue/90 font-extrabold py-4 rounded-lg transition-all mb-4 shadow-sm">
                <WhatsApp className='text-xl text-primary' />
                Contact Support
              </Link>
              <button className="w-full flex items-center justify-center gap-2 bg-white cursor-pointer hover:bg-slate-50 border border-slate-200 text-text-dark font-bold py-4 rounded-lg transition-all shadow-sm">

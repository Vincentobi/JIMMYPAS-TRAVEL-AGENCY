    ...
    <div className="relative mb-24">
      ...
      <div className="flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_200px_1fr] items-center g-8">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="order-2 md:order-1 text-right hiddend:block">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="order-3 bg-white dark:bg-slate-800/50 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_200px_1fr] items-center gap-8">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="order-3 md:order-1 bg-white dark:bg-slate-800/50 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-shadow md:text-right">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="order-2 md:order-3 text-left hidden md:block">
        ...
        {/* <!-- Step 3 --> */}
        <div className="grid grid-cols-1 md:grid-cols-[1fr_200px_1fr] items-center gap-8">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="order-2 md:order-1 text-right hidden md:block">

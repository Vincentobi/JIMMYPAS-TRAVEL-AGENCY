            ...
            {isOpen && (
                <div className="fixed inset-0 z-100 flex items-center justify-center p-4 backdrop-blur-sm bg-black/40">
                    ...
                    <motion.div
                        ...
                        className="bg-white dark:bg-zinc-900 w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden relative"
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute inset-0 -z-10" onClick={onClose}></motion.div>
                </div>
            )}
        </AnimatePresence>
    )
